...
public class BooleanArrayType implements UserType {
 ...
 SQLException {
 // setting the column with boolean array
 if (value != null && st != null) {
 Boolean[] castObject = (Boolean[]) value;
 Array array = session.connection().createArrayOf("boolean", castObject);
